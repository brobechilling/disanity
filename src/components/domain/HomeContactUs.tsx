        ...
        <div className="relative z-10 mx-auto flex max-w-4xl flex-col items-center px-5 py-12 text-center sm:px-8 lg:py-16">
          ...
          <form onSubmit={handleSubmit} className="mt-10 grid w-full gap-6 text-left sm:grid-cols-2">
            ...
            <div className="sm:col-span-2 sm:text-center">
              <button
                type="submit"
                className="inline-flex h-[55px] cursor-pointer items-center justify-center rounded-[40px] bg-[#6C0B0B] px-9 font-dMSans text-lg font-bold tracking-wide text-white shadow-md transition-all duration-200 hover:scale-105 hover:bg-[#A6341B] active:scale-95"
              >
                Send message
              </button>
            </div>
